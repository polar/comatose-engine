...
Having multiple roots allows you to use multiple roots, some of which may be
...
I've embedded Comatose in a couple of systems, and it's that was not an effort for the light
hearted with the embedding problems with Rails 2.3, engines plugin, dessert, etc.
In an effort to get something better in my next project, I gravitated toward
"Comfortable Mexican Sofa" by Oleg Khabarov, probably because of Ryan's Railscast mention.
...
It seems like since all this Ruby/Rails (stupid) "magic" exists, people feel they *must* use it!
Stop it people, just stop it. Get off the meth, and get back to writing good code. I don't know
WTF happend, but n my days, DRY stood for something you did when you got out of the water. "Don't
repeat yourself"? Really? I mean really? WTF? You mean, we should now all write small functions,
modularize code, and then put it together? Really? What the hell have they been teaching you in
College?
...
and eliminated all configuration options, and options of any kind. It does one thing and does
it well.

Hell, if you want to use embed this stuff, you should be a programmer, and you should know how to
modify/extend things so that they work they way you want it to, without having some obscure
configuration option crawling up your butt for 2 days.
...
to a rocket and fired into the virtual abyss. Go meet the Flying Spaghetti Monster.
