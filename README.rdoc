...
[+{{ pages['/path/to/page'] }}+] This selection refers to a page by the full path. If the path belongs to 2 or more pages, a collection will be returned, which may be iterated or selected with [0],[1], etc.
