...
In the Liquid implementation, access into variables is always by [],with "fetch" with an integer, or using "size", "first", and
"last" on collections. You may get somewhat creative by returning another Comatose::Variable by overriding []
...
[+body+] This field returns the body of the page, which is exactly what you may have typed in. Remember
